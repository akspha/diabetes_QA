...
def remove_tags(s):
    ...
    return str(bs(s,"html.parser").get_text())
    #return s.replace("<p>","").replace("</p>"," ")
    
def extract_information(q,list_types,focus,target, db, common_diabetes_questions_as_a_string, N):
    """
    ...
    for row_dic in articles:
            ...
            if num_common_words > 0:
                ...
                article = remove_tags(article.lower())
