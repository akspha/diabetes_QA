...
def put_data(data, db):
    ...
    for d in data:
        db.articles.insert({"article_section": d["article_section"], "section_title": d["section_title"], "article_title": d["article_title"], "date_scraped":datetime.datetime.today(), "url":""})
